            ...
            <div class="uk-section-small uk-section-default header">
                <div class="uk-container uk-container-large">
                    ...
                    <ul class="uk-breadcrumb">
                        ...
                        <li><span href="">Event Bookings</span></li>
                    </ul>
                </div>
            </div>
                        ...
                        <div uk-section-large>
                            <div class="uk-card uk-card-default">
                                <div class="uk-card-header">
                                    Event Bookings<br>
                                    <button class="uk-margin-top uk-label uk-label-success"><a href="eventbookings" style="color:white;border:none;">Refresh Data</a></button>
                                    <br>
                                    <br>
                                    <!-- Alert Box for Successful Verification -->
                                    <?php if ($_GET['success']) { ?>
                                        <div class="alert alert-success" style="color:green;font-size:12px;" role="alert">
                                            <strong><?=htmlspecialchars($_GET['success']) ?></strong>
                                        </div>
                                        <?php } ?>
    
                                     <!-- Alert Box for Error Verification -->
                                     <?php if ($_GET['error']) { ?>
                                        <div class="alert alert-danger" style="color:red;font-size:12px;" role="alert">
                                        ...
                                        <?php 
                                            ...
                                            mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
                                                    ...
                                                    if(!isset($_POST['submit'])){
                                                        $query = "SELECT * FROM client_eventbookings";
                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                            <a  class="uk-button uk-button-primary" style="font-size:11px;color:#fff;background-color:purple;" href="updateclientpayment?id=<?php echo htmlentities($phone);?>" onclick="return confirm('Update Client Status?');" >Update Status</a>
                                                        </td> 
                                                ...
                                                <?php
                                                    ...
                                                    $phone = $_POST['phonenumber'];
                                                        ...
                                                        if($phone != ""){
                                                            $query = "SELECT * FROM client_eventbookings WHERE client_phone='$phone'";
                                                            $data = mysqli_query($conn, $query) or die('error');
                                                            if(mysqli_num_rows($data) > 0){
                                                                $cnt=1;
                                                                while($row = mysqli_fetch_assoc($data)){
